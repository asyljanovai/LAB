...
pencil = pygame.image.load('lab9/photo_5230987540956307075_x.jpg')
...
bucket = pygame.image.load('lab9/photo_5230987540956307071_m.jpg')
bucket = pygame.transform.scale(bucket, (75, 75))

eraser = pygame.image.load('lab9/photo_5230987540956307070_m.jpg')
eraser = pygame.transform.scale(eraser, (75, 75))

figures = pygame.image.load('lab9/photo_5230987540956307076_m.jpg')
figures = pygame.transform.scale(figures, (75, 75))

rectangle = pygame.image.load('lab9/photo_5230987540956307073_m.jpg')
rectangle = pygame.transform.scale(rectangle, (75, 95))

circle = pygame.image.load('lab9/photo_5230987540956307077_y.jpg')
circle = pygame.transform.scale(circle, (75, 75))

pallete = pygame.image.load('lab9/photo_5230987540956307078_y.jpg')
